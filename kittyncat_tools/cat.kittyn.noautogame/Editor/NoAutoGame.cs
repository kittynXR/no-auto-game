...
namespace Catte.NoAutoGame
{
    internal static class NoAutoGame
    {
        ...
        #region Menu Items
        [MenuItem("Tools/⚙️🎨 kittyn.cat 🐟/NoAutoGame/Auto Unfocus Game Window", false, 3200)]
        ...
        [MenuItem("Tools/⚙️🎨 kittyn.cat 🐟/NoAutoGame/Auto Close Game Window", false, 3201)]
