...
Prevents Unity Game window from auto-opening or auto-focusing when entering play mode.

## Installation

### VRChat Creator Companion (Recommended)
1. In VCC, click "Manage Project"
2. Add the repository: `https://no-auto-game.kittyn.cat/index.json`
3. Find "cátte — NoAutoGame" in the package list and click "Add"

### Manual Installation
1. Download the latest release from [Releases](https://github.com/kittynXR/no-auto-game/releases)
2. Extract the zip file to your Unity project's `Packages` folder

## Documentation

See the [package README](kittyncat_tools/cat.kittyn.noautogame/README.md) for detailed usage instructions.
...
- [VPM Repository](https://no-auto-game.kittyn.cat/index.json)
- [GitHub Releases](https://github.com/kittynXR/no-auto-game/releases)
